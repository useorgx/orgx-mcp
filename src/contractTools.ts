...
export const CONTRACT_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      ...
      'Per-action requirements: spawn from an existing task REQUIRES task_id; ad-hoc spawn REQUIRES title + instructions and should include agent_type. handoff REQUIRES task_id + agent_type. guard REQUIRES agent_type. classify REQUIRES title or task_id. action="estimate" REQUIRES title or task_id, returns candidate routes/cost context, and runs without dispatching work. OAuth scopes: guard/classify/estimate require agents:read; spawn requires agents:write; handoff requires BOTH agents:write and initiatives:write.\n\n' +
